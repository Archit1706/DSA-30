...
<div className="relative overflow-hidden -mt-4">
  ...
  <div className="flex flex-col items-center justify-center text-center pt-16 pb-10 px-4">
    ...
    <div
      className="!text-4xl sm:!text-5xl md:!text-6xl lg:!text-7xl !leading-[1.25] md:!leading-[1.2] !font-extrabold tracking-tight mb-6 max-w-5xl"
      role="heading"
      aria-level={1}
    >
...
<div className="max-w-6xl mx-auto px-4 mb-24">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
    {[
      ...
      { d: 18, t: "Tries", c: "from-purple-500 to-fuchsia-500", live: true },
      { d: 19, t: "Segment Trees", c: "from-fuchsia-500 to-pink-500", live: true },
      { d: 20, t: "Union Find", c: "from-pink-500 to-rose-500", live: true },
      { d: 21, t: "Shortest Paths", c: "from-rose-500 to-red-500", live: true },
      { d: 22, t: "MST", c: "from-red-500 to-orange-500", live: true },
      { d: 23, t: "Topological Sort", c: "from-orange-500 to-amber-500", live: true },
      { d: 24, t: "Sliding Window", c: "from-amber-500 to-yellow-500", live: true },
      { d: 25, t: "Two Pointers", c: "from-yellow-500 to-lime-500", live: true },
      { d: 26, t: "Divide & Conquer", c: "from-lime-500 to-green-500", live: true },
      { d: 27, t: "Strings Advanced", c: "from-green-500 to-emerald-500", live: true },
      { d: 28, t: "System Design 101", c: "from-emerald-500 to-teal-500", live: true },
      { d: 29, t: "Mock Interview", c: "from-teal-500 to-cyan-500", live: true },
      { d: 30, t: "Victory Lap", c: "from-cyan-500 to-blue-500", live: true },
    ].map(({ d, t, c, live }) => (
      <Link
        key={d}
        href={live ? `/day${d}` : "#"}
