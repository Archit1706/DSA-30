---
title: "Day 17 — Bit Manipulation"
description: "Bit tricks for interviews — AND, OR, XOR, NOT, shifts, common idioms (clear lowest set bit, count bits, swap without temp), and 6 problems that show up everywhere."
---
