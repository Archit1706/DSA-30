---
title: "Day 8 — Hash Tables and Hash Functions"
description: "Hash tables under the hood — hash functions, collision handling (chaining, open addressing), load factor, and the lookup tricks that turn quadratic time into linear time."
---
...
4. **[Applications](/day8/applications)** — where hash tables actually earn their keep: caches, DB indices, Git's content addressing, deduplication, message routing.
5. **[Advanced Topics](/day8/advanced_topics)** — Bloom filters, consistent hashing for distributed systems, cuckoo & hopscotch hashing, hash flooding attacks, perfect hashing.
6. **[Basic Questions](/day8/basic_questions)** — warm-up exercises: design a tiny hash map, collision counting, hand-trace inserts, frequency tasks.
7. **[Practice Questions](/day8/practice_questions)** — ten interview classics that all collapse to "use a hash map."
