---
title: "Day 7 — Heaps and Priority Queues"
description: "Heaps from scratch — array-backed binary heaps, sift-up and sift-down, heapify, heap sort, and the top-K and merge-K-sorted patterns that dominate priority-queue interviews."
---
...
4. **[Applications](/day7/applications)** — where heaps actually earn their keep: Dijkstra, Huffman, top-K maintenance, event simulation, scheduling.
5. **[The Two-Heap Pattern](/day7/two_heaps)** — the max-min sandwich that gives you the running median in O(log n).
6. **[Basic Questions](/day7/basic_questions)** — warm-up exercises: verify heap property, trace operations, build heaps by hand.
7. **[Practice Questions](/day7/practice_questions)** — ten interview classics where a heap collapses an O(n log n) problem into something cleaner.
